...
@section('content')
    ...
    <div class="max-w-screen-xl m-auto mt-32">
        ...
        <section class="w-full flex items-center">
            <div class="w-1/2 font-light pr-5">
                ...
                <form action="" class="mt-12">
                    ...
                    <label class="block text-gray-700 text-sm font-bold mb-2 mt-12" for="username">
                        ¡Suscríbete para obtener novedades!
                    </label>
                    <input type="text" placeholder="{{ __('web.email') }}" name="email" class="shadow appearance-none border rounded w-64 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div class="w-1/2">
                <img src="{{ asset('images/pets.png') }}" alt="SukyCMS - Pets">
            </div>
        </section>
    </div>
