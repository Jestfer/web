<a class="block flex items-center hover:text-gray-700 mr-6" href="https://facebook.com/sukycms" target="_blank">
    <svg class="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Facebook</title><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" fill-rule="nonzero"></path></svg>
</a>
<a class="block flex items-center hover:text-gray-700 mr-6" href="https://twitter.com/sukycms" target="_blank">
...
<a class="block flex items-center hover:text-gray-700 mr-6" href="https://github.com/sukycms/sukycms" target="_blank">
